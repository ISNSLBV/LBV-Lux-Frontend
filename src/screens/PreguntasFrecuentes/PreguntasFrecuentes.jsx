...
const datosPreguntas = [
  {
    titulo: "¿Cómo puedo preinscribirme a la carrera?",
    descripcion:
  ...
  {
    titulo:
      "¿Hay alguna diferencia entre inscribirme como alumno regular, inscribirme como alumno oyente o alumno itinerante?",
    descripcion:
  ...
  {
    titulo: "¿Cómo puedo enterarme de las fechas de inscripción?",
    descripcion:
      "Las fechas de inscripción son publicadas anualmente en la página oficial del Instituto y en nuestras redes sociales, incluyendo Facebook e Instagram.",
  },
  {
    titulo:
      "¿Cuál es la documentación necesaria para inscribirse a una carrera?",
    descripcion:
  ...
  {
    titulo: "¿Cómo obtengo mi nombre de usuario y contraseña para el sistema?",
    descripcion:
      "Una vez que tu inscripción como alumno haya sido validada por la administración del Instituto, se te generará un usuario y contraseña para acceder al sistema de gestión académica. Recibirás esta información a través de tu correo electrónico registrado. En caso de no recibirla, contactá a la secretaría del Instituto.",
  },
  {
    titulo: "¿Hay cupos para la cantidad de alumnos de las carreras?",
    descripcion:
  ...
  },
  {
    ...
    descripcion:
      "Podés consultar los planes de estudio vigentes de cada carrera en la sección pública de consulta de planes de estudio de nuestra página web. Además, los programas detallados de cada materia estarán disponibles en el sistema de gestión académica, en un espacio que será cargado por los docentes.",
  },
  {
    titulo: "¿Cómo me inscribo a una materia?",
    descripcion:
      "La inscripción a las materias de cada cuatrimestre o año se realizará directamente a través del sistema de gestión académica del Instituto, al que accederás con tu usuario y contraseña. El sistema validará automáticamente el cumplimiento de las correlativas.",
  },
  {
  ...
  {
    titulo: "¿En qué meses hay finales y cuántos llamados existen?",
    descripcion:
      "Las mesas de exámenes finales ordinarias se desarrollan en los meses de Febrero‑Marzo (antes del inicio de clases), Agosto (post receso invernal) y Diciembre (fin del período de clases). Adicionalmente, existen turnos extraordinarios en Mayo o Septiembre, exclusivamente para aquellos alumnos que adeuden la última materia para finalizar su carrera.",
  },
  {
    titulo: "¿Cómo puedo inscribirme a una mesa final?",
    descripcion:
  ...
  {
    titulo: "¿Alguna materia puede ser rendida en condición de libre?",
    descripcion:
